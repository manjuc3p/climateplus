		...
		<div class="form-group row">
	  		...
	  		<div class="col-xs-12 col-sm-9 col-md-3 col-lg-3" role='group'>
				<select name="supplier_id" id="supplier_id" class="form-control select2" required tabindex='2'>
	     	    ...
	     	    <label class="col-xs-12 col-sm-1 col-md-2 col-lg-2 col-form-label">Supplier Quotation Code <span style="color: red;"> * </span></label>
	...
	<table class="table table-bordered table-hover" id="tab_logic">
		...
		<tr id="addr<?php echo $i;?>">
			...
			<td >
						...
						<textarea rows='2' cols='20' name="desc[]" id="desc<?php echo $i;?>" style="font-size:11px; font-weight:bold;" class="form-control form-control-sm" tabindex='9' required><?php echo $r->item_desc;?></textarea>
			</td>
			<td>
				<input type="number" name="trading_qty[]" id="trading_qty<?php echo $i;?>" tabindex='10' class="form-control form-control-sm" value="<?php echo $r->quantity;?>" required>
			</td>
			<td>
				<input type="number" step='0.01' name="price[]" id="price<?php echo $i;?>" class="form-control form-control-sm"  onchange="calculate_total('<?php echo $i;?>')" value=""  required>
			        <br>
				Total
				<input type="number" name="total[]" id="total<?php echo $i;?>" value="0.00" class="form-control bg-soft-gray form-control-sm subItemAmt" readonly required><br>
				
			</td>
			<td>
				<input type="text" name="item_remark[]" id="item_remark<?php echo $i;?>"  class="form-control form-control-sm" placeholder="remark" value="<?php echo $r->comment;?>">
