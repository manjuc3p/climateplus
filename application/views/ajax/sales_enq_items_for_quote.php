...
{?>
	...
	<table class="table table-bordered table-hover"  id="pdetails<?php echo $i; ?>">
		...
		<tr id="addr<?php echo $i;?>" style="background-color:#94C973!important; font-weight:bold">
			...
			<td>	
				<input type="number" name="manf_length[]" id="manf_length<?php echo $i;?>"  class="form-control bg-soft-gray form-control-sm" value="<?php echo $r->manf_length;?>" onchange="calculate_total('<?php echo $i;?>')">
			</td>
			<td>	
