<div class="card-body">
	...
	<form onsubmit="return check_selected_age();" id="main" method="post" action="<?php echo base_url().'index.php/'; ?>Sales/update_SAT_data" autocomplete="off" enctype="multipart/form-data">
		<div class="form-group row">
	  		...
	  		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-6">
				<select tabindex="1" class="form-select form-control-sm select2" id="dc_id" name="dc_id" disabled  >
				<option value="">Select</option>
				<?php foreach($dcrecords as $s) {?>
				 <option <?php if($s->dc_id==$row->dc_id) echo 'selected';?> value="<?php echo $s->dc_id ?>"><?php echo $s->dc_code.' '.$s->cust_name;?></option>
				<?php } ?>
			      </select>
    	     		 </div>
		</div>
		...
		<div class="form-group row">	    
				...
				<option value="">Select</option>
				<option <?php if($row->validation_approve=='1') echo 'selected';?> value="1">APPROVED</option>
				<option <?php if($row->validation_approve=='2') echo 'selected';?> value="2">REJECTED</option>
			      </select>
		...
		<div class="form-group row">
			 ...
			 <thead>
					...
					<tr id='addr0' style='font-size: 13px;'>
						<td><input type="text" name="bname[]" id="bname" tabindex='3' class="form-control" placeholder="EQUIPMENT FOR TEST" value="<?php echo $tr->test_name;?>" ></td>
		  	...
		  	<table class="table table-bordered table-hover" id="tab_stamp">
				   <thead>
					...
					<tr id='new_addr0' style='font-size: 13px;'>
						<td><input type="text" name="image_name[]" id="image_name" tabindex='4' class="form-control" placeholder="REFERENCE DOCUMENTATION"  value="<?php echo $tr->test_name;?>" ></td>
		...
		<div class="form-group row">
		  	<table class="table table-bordered table-hover" id="tab_stamp">
				   <thead>
					...
					<tr id='new_addr0' style='font-size: 13px;'>
						<td><input type="text" name="test_name[]" id="test_name0" tabindex='5' class="form-control"  value="<?php echo $tr->test_name;?>"></td>
						<td>
							<select name="test_result[]" class="form-select form-control-sm" required>
							    <option <?php if($tr->test_status=='1') echo 'selected';?> value="1">Passed</option>
							    <option <?php if($tr->test_status=='2') echo 'selected';?> value="2">Not Passed</option>
							    <option <?php if($tr->test_status=='3') echo 'selected';?> value="3">NA</option>
							    <option <?php if($tr->test_status=='4') echo 'selected';?> value="4">Approved</option>
							</select>
						</td>
						<td>
							<textarea  name="test_remark[]" id="test_remark0" tabindex='5' class="form-control"><?php echo $tr->test_remark;?></textarea>
						</td>
		  	...
		  	<table class="table table-bordered table-hover  bg-soft-primary" id="tab_stamp">
				   <thead>
					...
					<tr id='din_addr0' style='font-size: 13px;'>
						<td><input type="text" name="addr_name1[]" id="addr_name10" tabindex='6' class="form-control"   value="<?php echo $tr->test_phy_addr;?>"></td>
						<td><input type="text" name="realval1[]" id="realval10" tabindex='6' class="form-control" value="<?php echo $tr->test_real_value;?>" ></td>
						<td><input type="text" name="measuredval1[]" id="measuredval10" tabindex='6' class="form-control" value="<?php echo $tr->test_measured_value;?>" ></td>
						
						<td>
							<textarea  name="plc_remark1[]" id="plc_remark10" tabindex='6' class="form-control"><?php echo $tr->test_remark;?></textarea>
						</td>
						<td>
							<select name="plc_result1[]" class="form-select form-control-sm" tabindex='6'>
							    <option <?php if($tr->test_status=='Approved') echo 'selected';?> value="Approved">Approved</option>
							    <option <?php if($tr->test_status=='Not Approved') echo 'selected';?>  value="Not Approved">Not Approved</option>
							    <option <?php if($tr->test_status=='NA') echo 'selected';?>  value="NA">NA</option>
							</select>
						</td>
		  	...
		  	<table class="table table-bordered table-hover bg-soft-primary" id="tab_stamp">
				   <thead>
					...
					<tr id='dout_addr0' style='font-size: 13px;'>
						<td><input type="text" name="addr_name2[]" id="addr_name20" tabindex='7' class="form-control"  value="<?php echo $tr->test_phy_addr;?>"></td>
						<td><input type="text" name="realval2[]" id="realval20" tabindex='7' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						<td><input type="text" name="measuredval2[]" id="measuredval20" tabindex='7' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						
						<td>
							<textarea  name="plc_remark2[]" id="plc_remark20" tabindex='7' class="form-control"><?php echo $tr->test_remark;?></textarea>
						</td>
						<td>
		  	...
		  	<table class="table table-bordered table-hover bg-soft-success" id="tab_stamp">
				   <thead>
					...
					<tr id='ain_addr0' style='font-size: 13px;'>
						<td><input type="text" name="addr_name3[]" id="addr_name30" tabindex='8' class="form-control"  value="<?php echo $tr->test_phy_addr;?>"></td>
						<td><input type="text" name="realval3[]" id="realval30" tabindex='8' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						<td><input type="text" name="measuredval3[]" id="measuredval30" tabindex='8' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						
						<td>
							<textarea  name="plc_remark3[]" id="plc_remark30" tabindex='8' class="form-control"><?php echo $tr->test_phy_addr;?></textarea>
						</td>
						<td>
		  	...
		  	<table class="table table-bordered table-hover bg-soft-success" id="tab_stamp">
				   <thead>
					...
					<tr id='aout_addr0' style='font-size: 13px;'>
						<td><input type="text" name="addr_name4[]" id="addr_name40" tabindex='9' class="form-control"  value="<?php echo $tr->test_phy_addr;?>"></td>
						<td><input type="text" name="realval4[]" id="realval40" tabindex='9' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						<td><input type="text" name="measuredval4[]" id="measuredval40" tabindex='92' class="form-control" value="<?php echo $tr->test_phy_addr;?>" ></td>
						
						<td>
							<textarea  name="plc_remark14[]" id="plc_remark40" tabindex='9' class="form-control"><?php echo $tr->test_phy_addr;?></textarea>
						</td>
						<td>
		...
		<div class="form-group row">
			   ...
			   <div class="col-xs-12 col-sm-9 col-md-6 col-lg-6">
			      <textarea type="text" name="remark" id="remark" cols=30 rows=4 tabindex='14' class="form-control" placeholder="" ><?php echo $row->dremark;?></textarea>
			    </div>
		...
		<div class="form-group row">
			...
			<input type="hidden" id='sat_id' name='sat_id' value='<?php echo $row->sat_id;?>' class="form-control" >
...
$(document).ready(function(){
	...
	{
	     $('#addr'+i).html("<td><input type='text' name='bname[]' id='bname' tabindex='3' class='form-control' placeholder='EQUIPMENT FOR TEST'  required></td><td><a onclick='remove_row("+i+");' id='delete_row' title='Delete' tabindex='3' class='btn btn-xs bg-orange remove1'><span class='fa fa-trash'></span></a></td>");
	...
	{
	     $('#new_addr'+j).html("<td><input type='text' name='image_name[]' id='image_name"+j+"' tabindex='4'  class='form-control' placeholder='REFERENCE DOCUMENTATION' required></td><td><a onclick='remove_stamp_row("+j+");'  tabindex='4' id='delete_row1' title='Delete' class='btn btn-xs bg-orange remove1'><span class='fa fa-trash'></span></a></td>");
