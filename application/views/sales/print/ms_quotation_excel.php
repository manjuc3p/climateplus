	...
	<body topmargin=0 style="margin-left: 5px; margin-top:5px; font-family:Arial;">
		<center>
			...
			<table border=0 width='75%'>
				...
				<tr>
					<td height='50px'>
					<img src="<?php echo base_url().'public/logo/Header.jpg'?>" alt='logo.png' width='75%'></td>					
				</tr>
			...
			<table border='1' width='500px' style='border-collapse: collapse;'>
				<tr>
					<td bgcolor="#4cb5f1" align="center" colspan='8'>
						<b><font color="#ffffff" face="Arial" style="font-size:30px;">QUOTATION</font></b>
					</td>
				</tr>
				<tr>
					<td width='25%'>To:</td><td colspan='2' width='25%'><?php echo $customer_name;?></td><td  width='25%'>Quotation No:</td><td width='25%' colspan='4'><?php echo $quotation_code;?></td>
				</tr>
				<tr>
					<td width='25%'>Attn:</td><td colspan='2' width='25%'><?php echo $cp_name;?></td><td  width='25%'>Quotation Date:</td><td width='25%' colspan='4'><?php echo $quotation_date;?></td>
				</tr>
				<tr>
					<td width='25%'>TRN:</td><td colspan='2' width='25%'><?php echo $cust_trn;?></td><td  width='25%'>Your Ref:</td><td width='25%' colspan='4'><?php echo $client_ref;?></td>
				</tr>
				</table>
				<br/>
				<table border='1' width='100%' style='font-size: 12px; border-collapse: collapse;'>
						...
						<tr>
							...
							<td><?php echo $tr->quantity * $tr->unit_price; ?></td>
