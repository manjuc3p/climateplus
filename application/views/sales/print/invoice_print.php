	...
	<body topmargin=0 style="margin-left: 5px; margin-top:5px; font-family:Arial;">
		<center>
			...
			<table border=0 width=100%>
				...
				<tr><td><img src="<?php echo base_url().'public/logo/Header.jpg'?>" alt='logo.png' width=100% ></td><tr>
				</thead>
			</table>
			</header>
			<main>
			<table border=0 width=100%>
				<tr>
					<td colspan='2' align='center' style="font-size:23px;"><b><u> <?php if($invoice_type=='PI') echo 'SALES ORDER'; else echo 'TAX INVOICE'; ?> </b></u></td>
				</tr>
				<tr>
					<td  valign="top" align='left' width="50%" style="border:1px solid #ccc">
					<table width=100% border=0 style="font-family:Arial; font-size: 14px; line-height: 1.2">
					<tr>
						<td width="10%">Consigneee</td>
						<td width="40%"><b><?php echo $customer_name;?></b></td>
					</tr>
					<tr>
						<td width=40></td>
						<td ><?php echo $billing_addr.' <br>'.$billing_city.' '.$billing_pincode.' '.$billing_country;?></td>
					</tr>
					<tr>
						<td width=40>TEL:</td>
					...
					<td valign="top" align="right"  width="50%" style="border:1px solid #ccc">
						<table width=100% border=0 style="font-family:Arial; font-size: 14px; line-height: 1.2">
							<tr>
								<td width=20></td>
			...
			<table border='1' width='90%' height='100%' cellpadding='0' cellspacing=0>
				<thead>
					</tr>
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><?php echo $r->dis_per; ?></td>
					...
					<tr>
						...
						<tr>
						<td colspan='2'><?php if($grand_total>0)  echo $currabrev.' '.convert_number_to_words($grand_total);?></td>
						</tr>
						<tr>
						<td colspan='2'><b>VAT Amount (in words) </b></td>
						</tr>
						<tr>
						<td colspan='2'><?php if($vat_amt>0) echo $currabrev.' '.convert_number_to_words($vat_amt);?></td>
						</tr>
						<tr>
						<td colspan='2' style='font-size:12px;'><b>All cheques should be A/C payee and in favor of “Bangalore Elect Switchgear Assembly LLC"</b></td>
						</tr>

						<tr>
						<td style='font-size:12px;'><b>Bank Name</b></td>
						<td><?php echo $company_bank_name; ?></td>
						</tr>
						<tr>
						<td style='font-size:12px;'><b> Account No</b></td>
						<td><?php echo $company_bank_account; ?></td>
						</tr>
						<tr>
						<td style='font-size:12px;'><b>Bank Branch</b></td>
						<td><?php echo $company_bank_branch; ?></td>
						</tr>
						<tr>
						<td style='font-size:12px;'><b>Bank IBAN</b></td>
						<td><?php echo $bank_iban; ?></td>
						</tr>
						<tr>
						<td style='font-size:12px;'><b>Bank Swift</b></td>
						...
						<td></td><td></td>
						<td align="bottom"></td>
						<td align="center"><b>TOTAL (AED):</b><br><?php echo $sub_total; ?></td>
					</tr>
					<?php if($discount>0) { ?>
					<tr height="40px">
						
						<td  align="right"><b>DISCOUNT (AED)</b></td>
						<td align="center">
							<?php echo $discount;?>
						</td>
					</tr>
					<tr height="40px">
						<td  align="right"><b>TOTAL BEFORE VAT(AED)</b></td>
						<td align="center">
							<?php echo sprintf("%.2f", $sub_total-$discount); ?>
						</td>
					</tr>
					<?php } ?>
					<tr height="40px">
					<td></td><td></td>
						<td  align="right"><b>VAT <?php echo intval($vat_percent); ?>%</b></td>
						<td align="center">
							<?php echo sprintf("%.2f",$vat_amt); ?>
						</td>
					</tr>
					<tr height="40px">
					<td></td><td></td>
						<td  align="right"><b>GRAND TOTAL (AED)</b></td>
						<td align="center">
			...
			<table border='0' width='90%' cellpadding='0' cellspacing=0>
				<thead>
					<tr height="50px" style="font-family:Arial; font-size: 11px; font-weight: bold; text-align: center; border-right: 1px solid;">
						...
						<td width='60%'></td>
						<td align='center'><b>For Catalyst A/C Units Fix Cont.</b> </td>
						<td></td>
					</tr>
					<tr>
						<td width='60%'></td>
			...
			<table border=0 width=100% >
				<tr>
					<td align='center'><img  src="<?php echo base_url().'public/logo/Footer.jpg'?>" alt='logo.png' width="100%"></td>
				</tr>
