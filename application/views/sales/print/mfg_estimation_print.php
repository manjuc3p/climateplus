...
foreach($records1 as $row) {	
	...
	$enquiry_code=$row->estimate_id;
	$estimate_date=date('d-M-Y',strtotime($row->estimate_date));
	...
	<body style="margin-left: 5px; margin-top:5px; font-family:Arial;">
		...
		<table border=0 width=100%>
			...
			<table border='1' width='100%' style='border-collapse: collapse;font-family: Helvetica, sans-serif;'>
				<tr>
					<td bgcolor="#160D9F" align="center" colspan='4'>
						<b><font color="#ffffff" style="font-size:30px;">ESTIMATION</font></b>
					</td>
				</tr>
			</table>
			<br>
			<table border='1' width='100%' cellpadding="2" style='border-collapse: collapse;font-family: Helvetica, sans-serif;'>
				...
				<tr>
				<td  width='25%' bgcolor='#BFC9CA'>Estimate No:</td><td  width='75%'><?php echo $enquiry_code;?></td>
				</tr>
				<tr>
				<td  width='25%' bgcolor='#BFC9CA'>Estimate Date:</td><td  width='75%'><?php echo $estimate_date;?></td>
				</tr>
				...
				<table border='1' width='100%' cellpadding="10" style='font-size: 12px; border-collapse: collapse;font-family: Arial, sans-serif;'>
						...
						<tr>
							<td><?php echo $i;$i++; ?></td>
							<td><?php echo $tr->prd_category; ?></td>
							...
							<?php if($disc == 2) { ?>  <td><?php if($tr->dis_per > 0){$tot_dis+=(($tr->price*($tr->dis_per/100))*$tr->quantity);echo $tr->dis_per.'%';}  else if($tr->dis_val > 0){ $tot_dis+=$tr->dis_val;echo $tr->dis_val;}else{ echo 0;} ?></td> <?php } ?>
							<td><?php $tot+=($tr->quantity * $tr->price); echo $tr->quantity * $tr->price; ?></td>
