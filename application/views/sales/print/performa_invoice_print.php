...
<html>
	...
	<body topmargin=0 style="margin-left: 5px; margin-top:5px; font-family:Arial;">
		<center>
			...
			<table border=0 width=100%>
				<tr>
					<td colspan='2' align='center' style="font-size:23px;"><b><u> <?php if($invoice_type=='PI') echo 'PROFORMA'; else echo 'TAX'; ?> INVOICE</b></u></td>
				</tr>
				<tr>
			...
			<table border='1' width='90%' cellpadding='0' cellspacing=0>
				...
				<tbody>
					...
					<tr>
						...
						<td align="right"><b>TOTAL (AED)</b></td>
						<td align="center">
							<?php echo $sub_total; ?>
						</td>
					</tr>
