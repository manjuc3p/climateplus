...
function cost_sheet_calcualtion()
{
	...
	$('.price_value').each(function()
	{
		...
		tot_landedcost= parseFloat(tot_landedcost)+parseFloat(landedpamt);
		...
		tot_salescost=parseFloat(tot_salescost)+parseFloat(unit_sale_cost);
		...
		append_val++;
         ...
         document.getElementById("item_totallandedCost").innerHTML=parseFloat(tot_landedcost).toFixed(3);
         document.getElementById("item_totalsalePrice").innerHTML=parseFloat(tot_salescost).toFixed(3);
}
</script>
