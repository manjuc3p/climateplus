    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header table-card-header">
          <h5>Completion Delivery Report</h5>
        </div>
        <div class="card-block">
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Reports/get_completion_delivery_report" id="question" method="post" name="question" >
            <div class="form-group row">
              ...
              <label class="col-xs-6 col-sm-2 col-md-2 col-lg-2 col-form-label">Delivery Note</label>
              <div class="col-sm-3">
                <select tabindex="3" name="delivery_id" id="delivery_id" class="form-control select2">
                  <option value="">Please Select</option>
                  <?php foreach($delivery_records as $row) { ?>
                    <option <?php if($delivery_id==$row->dc_id) echo 'selected'; ?> value="<?php echo $row->dc_id;?>"><?php echo $row->dc_code.' / '.date('d-m-Y', strtotime($row->dc_date));?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <select tabindex="4" name="customer_id" id="customer_id" class="form-control select2" tabindex="3">
                  <option value="">Please select</option>
              ...
              <div class="col-sm-2">
                <table>
                  ...
                  <td>&nbsp;</td>
                  <td>
                    <form target="_blank" action="<?php echo base_url().'index.php/'; ?>Reports/print_completion_delivery_report" id="ques1" method="post" name="ques1" >
                    ...
                    <td>&nbsp;</td>
                    <td>
                      <form action="<?php echo base_url().'index.php/'; ?>Reports/export_completion_delivery_report" id="ques1" method="post" name="ques1" >
                        <input type="hidden" name="from" value="<?php echo $from; ?>" />
                        <input type="hidden" name="to" value="<?php echo $to; ?>" />
                        <input type="hidden" name="delivery_id" value="<?php echo $delivery_id; ?>" />
                        <input type="hidden" name="quotation_id" value="<?php echo $quotation_id; ?>" />
                ...
                <tbody>
                  <?php $i=1; foreach($records as $row) :?>
                    <tr>
                      ...
                      <td><a target='_blank' href="<?php echo base_url().'index.php/Sales/edit_quotation/'.$row->quot_id.'/'.$row->revision;?>"><?php echo $row->quotation_code; ?></a></td>
