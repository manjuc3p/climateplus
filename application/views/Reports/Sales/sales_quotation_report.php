    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header table-card-header">
          <h5>Sales Quotation to Customer Report</h5>
        </div>
        <div class="card-block">
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Reports/get_sales_quotation_report" id="question" method="post" name="question" >
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <table>
                  ...
                  <td>&nbsp;</td>
                  <td>
                    <form target="_blank" action="<?php echo base_url().'index.php/'; ?>Reports/print_sales_quotation_report" id="ques1" method="post" name="ques1" >
                    ...
                    <td>&nbsp;</td>
                    <td>
                      <form action="<?php echo base_url().'index.php/'; ?>Reports/export_sales_quotation_report" id="ques1" method="post" name="ques1" >
                        <input type="hidden" name="from" value="<?php echo $from; ?>" />
                        <input type="hidden" name="to" value="<?php echo $to; ?>" />
                        <input type="hidden" name="customer_id" value="<?php echo $customer_id; ?>" />
                        <input type="hidden" name="status" value="<?php echo $status; ?>" />
