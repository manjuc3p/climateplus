  ...
  <main>
    <center>
      <table cellpadding=10 border=0 width=100%>
        <tr>
          <td bgcolor="#0394fc" align="center" height='22px'><b>
              <font color="#ffffff" face="Arial" style="font-size:30px;"> JOBS REPORT(<?php echo 'from ' . date('d-M-Y', strtotime($from_date)) . ' to ' . date('d-M-Y', strtotime($to_date)); ?>)</font>
            </b></td>
