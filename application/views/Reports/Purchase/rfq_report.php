    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-block">
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Reports/get_rfq_report" id="question" method="post" name="question" >
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <table>
                  <tr>
                    <td>
                      <input tabindex="7" type="submit" id="view" name="go" value="Go" class="btn btn-sm btn-primary m-b-0" />
                    </form>
                  </td>
                  <td>&nbsp;</td>
                  <td>
                    <form target="_blank" action="<?php echo base_url().'index.php/'; ?>Reports/print_rfq_report" id="ques1" method="post" name="ques1" >
                      ...
                      <input tabindex="8" type="submit" id="print" value="Print" class="btn btn-warning btn-sm" />
                    </form></td>
                    <td>&nbsp;</td>
                    <td>
                      <form action="<?php echo base_url().'index.php/'; ?>Reports/export_rfq_report" id="ques1" method="post" name="ques1" >
                        <input type="hidden" name="from" value="<?php echo $from; ?>" />
                        <input type="hidden" name="to" value="<?php echo $to; ?>" />
                        <input type="hidden" name="status" value="<?php echo $status; ?>" />
                        <input type="hidden" name="created_by" value="<?php echo $created_by; ?>" />
												<input type="hidden" name="supplier_id" value="<?php echo $supplier_id; ?>" />
                        <input type="hidden" name="supplier_type" value="<?php echo $supplier_type; ?>" />
                        <input tabindex="9" type="submit" id="export" value="Export to excel" class="btn btn-warning btn-sm" />
                      </form>
                    </td>
                  </tr>
                </table>
              ...
              <table id="basic-btn" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                  <?php $i=1; foreach($records as $row) :?>
                    <tr>
											<td><?php echo  $i; $i++;?></td>
											<td><a target='blank' title="RFQ Details" href="<?php echo base_url().'index.php/Purchase/view_rfq_details/'.$row->rfq_id.'/'.$row->rev_version;?>"><?php echo $row->rfq_code; ?></a></td>
                      <td><?php echo date('d-M-Y',strtotime($row->rfq_date)); ?></td>
											...
											<td><?php echo $row->rev_version; ?></td>
