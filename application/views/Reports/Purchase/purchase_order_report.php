    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-block">
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Reports/get_purchase_order_report" id="question" method="post" name="question" >
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <select tabindex="3" name="status" id="status" class="form-control">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <table>
                  ...
                  <td>&nbsp;</td>
                  <td>
                    <form target="_blank" action="<?php echo base_url().'index.php/'; ?>Reports/print_purchase_order_report" id="ques1" method="post" name="ques1" >
                    ...
                    <td>&nbsp;</td>
                    <td>
                      <form action="<?php echo base_url().'index.php/'; ?>Reports/export_purchase_order_report" id="ques1" method="post" name="ques1" >
                        <input type="hidden" name="from" value="<?php echo $from; ?>" />
                        <input type="hidden" name="to" value="<?php echo $to; ?>" />
                        <input type="hidden" name="status" value="<?php echo $status; ?>" />
                        <input type="hidden" name="supplier_type" value="<?php echo $supplier_type; ?>" />
              ...
              <table id="basic-btn" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                  <?php $i=1; foreach($records as $row) :?>
                    <tr>
                      <td><?php echo  $i; $i++;?></td>
                			<td><a title="PO Details" target='blank' href="<?php echo base_url().'index.php/Purchase/view_po_details/'.$row->po_id.'/'.$row->rev_version;?>"><?php echo $row->po_code; ?></a></td>
