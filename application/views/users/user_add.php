<div class="card-body">
	<form id="main" method="post" action="<?php echo base_url().'index.php/'; ?>Users/add_new_user" autocomplete="off" enctype="multipart/form-data">
		...
		<div class="form-group row">
		  ...
		  <div class="col-xs-12 col-sm-9 col-md-3 col-lg-3">
		    <input tabindex="4" type="email" name="company_email" id="company_email" readonly class="form-control form-control-sm" onfocus="this.removeAttribute('readonly');" required onblur="check_duplicate_exist();" >
