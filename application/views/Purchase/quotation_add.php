...
<div class="card-body">
	<form onsubmit="return check_selected_age();" id="main" method="post" action="<?php echo base_url().'index.php/'; ?>Purchase/add_purchase_quotation_records" autocomplete="off" enctype="multipart/form-data">
		<div class="form-group row">
	  		<label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">Select RFQ</label>
	  		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-4" role='group'>
				...
				<?php foreach($records as $s) {?>
				  <option value="<?php echo $s->rfq_id ?>"><?php echo $s->rfq_code.' '.$s->supplier_name;?></option>
				<?php } ?>
			      </select>
    	     		 </div>
		    	<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 col-form-label">Quotation date <span style="color: red;"> * </span></label>
	...
	<div id="item_list_id"> 
		...
		<div class="form-group row">
			...
			<button type="submit"  tabindex="6"  id="add" class="btn btn-primary m-b-0">Create Quotation</button>
			</div>
		</div>
	    </form>
...
function get_rfq_info()
{
	var qid = document.getElementById("qid").value;	
   	if(qid!='')
   	{
	   	...
	   	async:"false",
		type: "POST",
		url:"<?php echo base_url()?>index.php/Ajax/ajax_get_rfq_for_quote",
		data: {qid:qid} ,
