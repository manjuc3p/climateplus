		...
		<table id="datatable" class="table table-striped" data-toggle="data-table">
			<thead>
				<tr>
					...
					<th style='width:8%'>Job Date</th>
					<th style='width:25%'>Job Description</th>
					<th style='width:8%'>Job Location</th>
			...
			<tbody>
				...
				foreach ($records as $row) : ?>
					<tr>
						...
						<td style='width:10%'><?php echo $row->job_title; ?></td>
						<td style='width:8%'><?php echo $row->job_date; ?></td>
						<td style='width:25%'><?php echo $row->job_desc; ?></td>
						<td style='width:8%'><?php echo $row->job_location; ?></td>
						<td style='width:15%'>
							<?php echo $row->additional_notes; ?>
						</td>
						<td style='width:10%'>
