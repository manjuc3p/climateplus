...
<?php $dept = $this->session->userdata('dept'); ?>
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Operations/daily_job_list" id="form1" method="post">
            <div class="form-group row">
              <label class="col-xs-6 col-sm-1 col-md-1 col-lg-1 col-form-label">Date45 <span style="color: red;"> * </span></label>
                    ...
                    <?php $i=1;foreach ($jobs as $job): ?>
                        <tr>
                            ...
                            <?php echo htmlspecialchars($job['job_title']); ?><br>
                              Customer : <?php echo $job['customer'];if($job['contact']) echo '(contact:'.$job['contact'].')' ?><br>
