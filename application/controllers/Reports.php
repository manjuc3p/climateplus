...
class Reports extends CI_Controller
{
  ...
  function get_payment_report()
  {
    ...
    if (!$print) {
      ...
      $this->load->view('Reports/print/payment_report.php', $data);
    }
  }
  ...
  function jobs_report()
  {
    ...
    $print = $_POST['print_opt'] ?? 0;
    $this->load->model('Operations_model');
    $data['jobs'] = $this->Operations_model->get_all_jobs($data['from_date'], $data['to_date'], $data['status']);

    if ($print == 0) {
      $data['main_content'] = 'Reports/job_report.php';
      $this->load->view('includes/template.php', $data);
    } else {
      $this->load->view('Reports/print/job_report.php', $data);
    }
  }
