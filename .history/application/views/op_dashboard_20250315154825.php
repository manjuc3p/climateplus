...
<div class="row">
   <div class="col-md-12 col-lg-12">
      ...
      <!-- <div class="dropdown">
         <a href="#" class="text-white dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">
            This Week
         </a>
         ...
         <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
              <input type="date" name="job_date" id="job_date" class="form-control form-control-sm" value='<?php echo date('Y-m-d') ?>' />
	  		</div>
         </form>
         <br>
