           ...
           <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
              <div class="card-body">
                 <div class="progress-widget">
                    ...
                    <div class="progress-detail">
                       <p  class="mb-2">Total Cosh Collected<?php echo '('.date('M-Y').')'; ?></p>
                       <h4 class="counter"><?php echo $job_summary['collected_amt']; ?></h4>
                    </div>
                 </div>
              </div>
           </li>
           <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000">
              <div class="card-body">
                 <div class="progress-widget">
                    ...
                    <div class="progress-detail">
                       <p  class="mb-2">Total Cosh with Team<?php echo '('.date('M-Y').')'; ?></p>
                       <h4 class="counter"><?php echo $job_summary['amt_with_team']; ?></h4>
                    </div>
                 </div>
              </div>
           </li>
