	...
	<form id="main" method="post" action="<?php echo base_url().'index.php/'; ?>Operations/send_mail" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">Message</label>
	  		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-6">
              <textarea name="email_message" tabindex="3" id="email_message" rows=5 cols=100 class="form-control form-control-sm" required>Greetings from Climate Plus LLC! Please find the attached documents. Let us know if you have any questions or require further assistance.</textarea>
	  		</div>
			<input type='hidden' name='staff_name' value='<?php echo $job_det['staff']; ?>' />
			<input type='hidden' name='staff_dept' value='<?php echo $job_det['dept_name']; ?>' />
        </div>
