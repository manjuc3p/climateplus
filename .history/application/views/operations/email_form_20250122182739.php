	...
	<form id="main" method="post" action="<?php echo base_url().'index.php/'; ?>Operations/send_mail" autocomplete="off" enctype="multipart/form-data">
        <div class="form-group row">
		    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">To: </label>
              ...
              <input tabindex="1" type="text" name="email_to" id="email_to" class="form-control form-control-sm" value='' />
	  		</div>
        </div>
        <div class="form-group row">
		    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">Subject: </label>
	  		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-6">
              <input tabindex="1" type="text" name="email_subject" id="email_subject" class="form-control form-control-sm" value='' />
	  		</div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">Message</label>
	  		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-6">
              <textarea name="email_message" tabindex="3" id="email_message" rows=5 cols=100 class="form-control form-control-sm" ></textarea>
	  		</div>
        </div>
                ...
                <table class="table table-bordered table-hover" id='tab_logic'>
                    ...
                    <tbody id="file_table">
                        ...
                        <tr id='addr0'>
						    <td>1</td>
                            <td>                               
                                <input id="mail_file0" name="mail_file[]" type="file">                                
                            </td>
                            <td>                               
