...
<?php $dept = $this->session->userdata('dept'); ?>
          <form class="form-horizontal" action="<?php echo base_url().'index.php/'; ?>Operations/daily_job_list" id="form1" method="post">
            ...
            <table class="table table-striped table-bordered nowrap">
                <thead>
                  <tr>
                    <th style="width: 150px;">Company1</th>
                ...
                <tbody>
                    <?php $i=1;foreach ($jobs as $job): ?>
                        <tr>
                            ...
                            <td style="width: 100px;"><?php echo $job['job_time']??'Not Assigned'; ?></td>
                            <td style="width: 100px;"><?php echo htmlspecialchars($job['contact']); ?></td>
                            <td style="width: 100px;"><?php echo htmlspecialchars($job['job_title']); ?></td>
                            <td style="width: 100px;"><?php echo $job['term']; ?></td>
                            <td style="width: 100px;"><?php echo $job['sales']; ?></td>
