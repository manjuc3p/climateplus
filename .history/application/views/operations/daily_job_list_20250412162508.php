                ...
                <tbody>
                    <?php $i=1;foreach ($jobs as $job): ?>
                        <tr>
                            ...
                            <td style="width: 150px;"><?php echo $job['job_time']??'Not Assigned'; ?></td>
                            <td style="width: 150px;"><?php echo htmlspecialchars($job['contact']); ?></td>
                            <td style="width: 150px;"><?php echo htmlspecialchars($job['job_title']); ?></td>
                            <td style="width: 150px;"><?php echo $job['term']; ?></td>
                            <td style="width: 150px;"><?php echo $job['sales']; ?></td>
