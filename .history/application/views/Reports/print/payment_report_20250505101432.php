	...
	<main>
		<center>
			<table cellpadding=10 border=0 width=100%>
                <tr>
                    <td bgcolor="#0394fc" align="center" height='22px'><b><font color="#ffffff" face="Arial" style="font-size:30px;"> PAYMENT REPORT-<?php echo date('d-M-Y',strtotime($job_date)); ?></font></b></td>
                </tr>
                <tr>
