...
class Admin extends CI_Controller {
	...
	function view_accounts_dashboard() 
	{
		$data['today'] = date('Y-m-d');
		$this->load->model('Operations_model');
		$data['job_summary'] = $this->Operations_model->get_job_summary_for_accounts();
		print_r($data['job_summary']);
		// $data['main_content'] = 'acc_dashboard.php';
		// $this->load->view('includes/template_home', $data);
	}
